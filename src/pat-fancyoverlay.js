(function (root, factory) {
    ...
    var log = logger.getLogger("pat-fancyoverlay");
     ...
     * data-pat-fancyoverlay attribute, then you need to
     ...
     */
    parser.addArgument("text", "Patternslib pat-fancyoverlay demo with default options.");
    ...
    return Base.extend({
        ...
        init: function initUndefined () {
             ...
             *
             * If the user provided any values via the data-pat-fancyoverlay
